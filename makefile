student:main.o student_add.o student_show.o student_delete.o student_modify.o student_save.o student_sort.o student_reverse.o 
	cc main.c student_add.c student_show.c student_delete.c student_modify.c student_save.c student_sort.c student_reverse.c -o student
main.o:main.c 
	cc -c main.c 
